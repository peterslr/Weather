# This program uses the weather api to get historical forecast info
# for a city and date input by the user
# version 2.3 July 6,2022
import requests
import json
import pprint
import pandas as pd
...
usersdate = input("What recent date would you like weather data for?"
